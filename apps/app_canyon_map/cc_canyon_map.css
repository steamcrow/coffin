...
/*    Styled like field survey annotations: hand-stamped, aged paper,      */
/*    ink-on-parchment. Orange-red ink, worn edges, no glow or tech.       */
...
.cc-map-hitbox-label {
    ...
    /* Aged parchment — warm off-white with a slight texture tint */
    background: rgba(42, 28, 12, 0.91) !important;

    border-top:    1px solid rgba(210, 130, 40, 0.5) !important;
    border-right:  1px solid rgba(210, 130, 40, 0.5) !important;
    border-bottom: 1px solid rgba(210, 130, 40, 0.5) !important;
    border-left:   3px solid #d4822a !important;   /* stamp edge */
    border-radius: 0 2px 2px 0 !important;

    color: #e8c07a !important;           /* aged ink — warm amber */
    ...
    /* Worn paper shadow — no glow, just depth */
    box-shadow:
        1px 1px 0 rgba(0,0,0,.6),
        2px 2px 0 rgba(0,0,0,.3),
        0 3px 10px rgba(0,0,0,.7) !important;

    /* Subtle ink bleed on text */
    text-shadow: 0 1px 2px rgba(0,0,0,.8) !important;
}

/* Small filled square before the name — like a survey mark stamped in ink */
...
/* On hover: warm amber fill — like a map region being pencilled in */
.leaflet-interactive:not(.cc-hb-box):hover {
  fill: #d4822a !important;
  fill-opacity: 0.22 !important;
  stroke: #d4822a !important;
  stroke-width: 2 !important;
  filter: drop-shadow(0 0 5px rgba(212,130,42,.4)) !important;
}
